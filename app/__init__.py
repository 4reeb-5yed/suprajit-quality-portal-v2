...
from app.database import GET_USER_BY_ID, ensure_schema, get_connection
...
def create_app(test_config=None):
    ...
    def add_security_headers(response):
        ...
        response.headers["Content-Security-Policy"] = (
            "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' https://unpkg.com https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://cdn.grapecity.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://cdn.grapecity.com; font-src 'self' https://cdnjs.cloudflare.com https://cdn.grapecity.com; img-src 'self' data: blob:; connect-src 'self' blob: data: https://cdn.jsdelivr.net https://unpkg.com https://cdn.grapecity.com;"
        )
    ...
    with app.app_context():
        ...
        if admin_count == 0:
            ...
            conn.execute(
                "INSERT INTO users (username, password_hash, display_name, role) VALUES ('bootstrap_admin', ?, 'Administrator', 'admin')",
                (default_pass,),
            )
            conn.commit()
